$(document).ready(function() {
    ...
    let umetnina1 = new Umetnina("Apolon Belvedere", umetnik4, "skulptura", 1000, 10, "slike/skulptura1.jpg");
    let umetnina2 = new Umetnina("Bacač diska", umetnik5, "skulptura", 2000, 20, "slike/skulptura2.jpg");
    let umetnina3 = new Umetnina("Aleksandar Veliki", umetnik6, "skulptura", 3000, 30, "slike/skulptura3.jpg");
    let umetnina4 = new Umetnina("Bokser u odmoru", umetnik7, "skulptura", 1000, 500, "slike/skulptura4.jpg");
