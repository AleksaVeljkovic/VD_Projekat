...
let umetnik8 = new Umetnik("Miquel", "Barcelo", new Tekst("Miquel Barcelo je španski slikar i keramičar rođen 1957. godine. Njegov rad obuhvata širok spektar medija, uključujući slikarstvo, skulpturu, keramiku i crteže. Barcelo je poznat po svom eksperimentalnom pristupu materijalima i teksturama, stvarajući slojevite i organske kompozicije.Njegov najpoznatiji rad je možda dekoracija skupštinske dvorane Ujedinjenih nacija u Ženevi, koja prikazuje podvodni svet i simbolizuje globalnu povezanost.",
"Miquel Barcelo is a Spanish painter and ceramist born in 1957. His work spans a wide range of media, including painting, sculpture, ceramics and drawings. Barcello is known for his experimental approach to materials and textures, creating layered and organic compositions. His most famous work is perhaps the decoration of the United Nations Assembly Hall in Geneva, which depicts the underwater world and symbolizes global connectivity.  "), "slike/umetnik8.jpg", "lokacija pdf-a");


function prikaziStranicuUmetnici(lang) {
    let tekstMenija = [
...
let lang = sessionStorage.getItem("lang"); prikaziStranicuUmetnici(lang);
$("#srpski").click(function() { lang = "srp"; sessionStorage.setItem("lang", lang); prikaziStranicuUmetnici(lang);});
$("#engleski").click(function() { lang = "eng"; sessionStorage.setItem("lang", lang); prikaziStranicuUmetnici(lang) });
